...
{
    [TestFixture]
    public class TattooLogicTests
    {
        TattooLogic tattooLogic { get; set; }
        ...
        public void Init()
        {
            ...
            this.tattooLogic = new TattooLogic(mockedCustomerRepository.Object, mockedJobsDoneRepository.Object, mockedTattooRepository.Object);
        }
