...
{
    [TestFixture]
    public class JobsDoneLogicTests
    {
        JobsDoneLogic jobsDoneLogic { get; set; }
        ...
        public void Init()
        {
            ...
            this.jobsDoneLogic = new JobsDoneLogic(mockedCustomerRepository.Object, mockedJobsDoneRepository.Object, mockedTattooRepository.Object);
        }
